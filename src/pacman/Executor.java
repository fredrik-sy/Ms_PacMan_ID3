...
import dataRecording.StarterDataCollectorController;
import pacman.controllers.Controller;
import pacman.controllers.HumanController;
import pacman.controllers.KeyBoardInput;
import pacman.controllers.decisionTree.DTController;
...
//		exec.runGameTimed(new HumanController(new KeyBoardInput()),new StarterGhosts(),visual);	
		...
		*/
		...
		//exec.runExperiment(new StarterDataCollectorController(),new StarterGhosts(),numTrials);
		//exec.runExperiment(new StarterDataCollectorController(),new AggressiveGhosts(),numTrials);
		//exec.runExperiment(new StarterDataCollectorController(),new RandomGhosts(),numTrials);
		exec.runGameTimed(new DTController(),new StarterGhosts(),visual);
	}
